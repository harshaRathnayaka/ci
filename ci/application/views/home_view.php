            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="components.html">Control</a></li>
                        <li><a href="gallery-4.html">sign in</a></li>
                        ...
                        <div class="col-xs-12 col-sm-3 col-md-3 portfolio-masonry-item web">
                            <div class="gallery-item">
                                <div class="media-content">
                                    <button id="login" class="btn btn-primary btn-lg" data-toggle="modal" >Add Admin</button>
                                    <h2>Add Admin</h2>
                                </div>
                            </div>
                        </div>
